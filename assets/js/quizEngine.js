/* ============================================================================
   CISSP  ::  quizEngine.js  —  ENGINE  (assessment + PBQ runtime)
   The question bank (content/quiz1..8.js) and PBQ database (content/pbqs.js)
   load before this file and populate CISSP.questions / CISSP.pbqs.
   ...
   read from CISSP.exam — the single source of truth — never re-literaled.
   ========================================================================== */
(function () {
  "use strict";
  ...
  /* ===========================================================================
     ...
     Persists two things across every quiz/mock session (localStorage via APP):
       cissp.objstats.v1 = { "1.2": {c, n}, ... }   per-objective accuracy
       cissp.missed.v1   = { "D4-071": 1, ... }      questions answered wrong
  ...
  /* ===========================================================================
     ...
     Length and duration come from CISSP.exam (single source of truth).
     =========================================================================== */
  ...
  window.QUIZ = {
    ...
    startQuickQuiz: function () {
      runLinearQuiz({
        ...
        title: "Randomized Quick Quiz", sub: "10 questions · all eight domains",
